(function () {
    ...
    var adminDashBoardController = function ($scope, adminRestDAL) {
        ...
        //Use statistic to check how many answers are unrevised
        //count = total (all courses)
        adminRestDAL.getNewAnswers().$promise
            .then(
                function (data) {
        ...
        adminRestDAL.getAnswersStatistics().$promise
            .then(
                function (data) {
        ...
        adminRestDAL.getAnswersStatisticsGraph().$promise
            .then(
                function (data) {
